...
if (!isset($_FILES['image']['tmp_name'])) {
  ...
  $email = $_POST['email'];
    ...
    $status=1;
            ...
            $save=mysqli_query($con,"INSERT INTO adminlogin (img,username,email,password,contact,status,type) VALUES ('$img','$username','$email','$password','$contact','$status','$type')");
  ...
  <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label for="inp-type-1" class="col-sm-3 control-label">Type</label>
								<div class="col-sm-6">
...
<tr>
  ...
  <td><i data="<?php echo $user['id'];?>" class="status_checks btn-sm <?php echo ($user['status'])? 'btn-success' : 'btn-danger'?>"><?php echo ($user['status'])? 'Active' : 'Inactive'?></i></td>
