...
if (!isset($_FILES['image']['tmp_name'])) {
    ...
    $file=$_FILES['image']['tmp_name'];
            ...
            $save=mysqli_query($con,"INSERT INTO slider (img,title,description,buttonname,link) VALUES ('$img','$title','$description','$buttonname','$link')");
...
?>
  <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="buttonname" class="form-control" id="title" placeholder="Enter Title..">
								</div>					
							</div>
							<div class="form-group">
								<label for="ninty" class="col-sm-3 control-label">Link</label>
								<div class="col-sm-9">
									<input type="text" name="link" class="form-control" id="title" placeholder="Enter Title..">
								</div>					
							</div>
						...
						<tbody>
							<tr>
								 ';?>
                                                    ...
                                                    <?php echo '
								<td><img style="width:50px" src="../images/sliders/'.$row['img'].'"></td>
