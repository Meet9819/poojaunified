	...
	<div class="main-content">
			...
			<div style="text-align: right;" class="col-xs-12">
				<div class="box-content">
					<a href="servicesadd.php"  class="btn btn-default btn-sm waves-effect waves-light"> Add </a> 
				</div>
			</div> 
...
echo '	<tbody>
			<tr>
			 ';?>
                                ...
                                <?php echo '	<td><img style="width:100px" src="media/services/'.$row['img'].'"></td>						 
								...
								<td>
								 <a class="delete btn btn-danger btn-xs waves-effect waves-light" href="?del='.$row['id'].'"> <i class="fa fa-trash-o"></i></a></td>
							</tr>
						</tbody>                                 
