						...
						<tbody>
							<tr>
								 ...
								 <td> ';
									...
									$subresult = mysqli_query($con,"SELECT * FROM menu where menu_id = $parent_id"); 
...
<td>
   ...
   <button style="background-color:#304ffe;color:white" type="button" class="btn  btn-xs"><i class="fa fa-pencil"></i></button>
  		  ...
  		  <a class="btn btn-danger btn-xs waves-effect waves-light" href="?del='.$row['menu_id'].'"> <i class="fa fa-trash-o"></i></a> 
			</td>
