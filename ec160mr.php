...
<?php include 'header2.php';?>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header mb-5 p-0 wow fadeIn" data-wow-delay="0.1s" style="background-image: url(img/carousel-3.jpg);">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    <div id="detail-carousel" class="carousel slide mb-5" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="w-100" src="img/blog-lg-1.jpg" alt="Image">
                            </div>
                            <div class="carousel-item">
                                <img class="w-100" src="img/blog-lg-2.jpg" alt="Image">
                            </div>
                        </div>
                    ...
                    <div class="bg-light d-flex flex-column flex-sm-row p-4 mb-5 wow fadeInUp" data-wow-delay="0.1s">
                        <img class="img-fluid flex-shrink-0 mb-4 mb-sm-0" src="img/user-1.jpg" style="width: 100px; height: 100px;"/>
                        <div class="ps-sm-4">
                            <h3>Author Name</h3>
                            <p class="mb-0">
                    ...
                    <div class="mb-5 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="owl-carousel related-carousel position-relative">
                            <div class="d-flex bg-light p-4">
                                <img class="img-fluid flex-shrink-0" src="img/blog-sm-1.jpg" style="width: 75px; height: 75px; object-fit: cover;" alt="">
                                <div class="ps-3">
                            ...
                            <div class="d-flex bg-light p-4">
                                <img class="img-fluid flex-shrink-0" src="img/blog-sm-2.jpg" style="width: 75px; height: 75px; object-fit: cover;" alt="">
                                <div class="ps-3">
                                    <a href="#" class="h5 mb-0">Lorem ipsum dolor sit amet consec adipis elit</a>
                                    <div class="breadcrumb blog-meta mb-0">
                                        <small class="breadcrumb-item"><a href="#">01 Jan, 2045</a></small>
                            ...
                            <div class="d-flex bg-light p-4">
                                <img class="img-fluid flex-shrink-0" src="img/blog-sm-3.jpg" style="width: 75px; height: 75px; object-fit: cover;" alt="">
                                <div class="ps-3">
                                    <a href="#" class="h5 mb-0">Lorem ipsum dolor sit amet consec adipis elit</a>
                                    <div class="breadcrumb blog-meta mb-0">
                                        <small class="breadcrumb-item"><a href="#">01 Jan, 2045</a></small>
                    ...
                    <div class="mb-5 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="d-flex mb-4">
                            <img src="img/user-1.jpg" class="img-fluid flex-shrink-0" style="width: 45px; height: 45px;">
                            <div class="ps-3">
                        ...
                        <div class="d-flex mb-4">
                            <img src="img/user-2.jpg" class="img-fluid flex-shrink-0" style="width: 45px; height: 45px;">
                            <div class="ps-3">
                                <h5>John Doe <small class="text-body fw-normal fst-italic">01 Jan 2045</small></h5>
                                <p class="mb-2">Diam amet duo labore stet elitr invidunt ea clita ipsum voluptua, tempor labore
                                    accusam ipsum et no at. Kasd diam tempor rebum magna dolores sed eirmod</p>
                        ...
                        <div class="d-flex ms-5 mb-4">
                            <img src="img/user-3.jpg" class="img-fluid flex-shrink-0" style="width: 45px; height: 45px;">
                            <div class="ps-3">
                                <h5>John Doe <small class="text-body fw-normal fst-italic">01 Jan 2045</small></h5>
                                <p class="mb-2">Diam amet duo labore stet elitr invidunt ea clita ipsum voluptua, tempor labore
                                    accusam ipsum et no at. Kasd diam tempor rebum magna dolores sed eirmod</p>
    ...
    <script data-cfasync="false" src="cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="code.jquery.com/jquery-3.4.1.min.js" type="59e992efeb54918d74bd7804-text/javascript"></script>
    <script src="cdn.jsdelivr.net/npm/bootstrap%405.0.0/dist/js/bootstrap.bundle.min.js" type="59e992efeb54918d74bd7804-text/javascript"></script>
    <script src="lib/wow/wow.min.js" type="59e992efeb54918d74bd7804-text/javascript"></script>
    <script src="lib/easing/easing.min.js" type="59e992efeb54918d74bd7804-text/javascript"></script>
    <script src="lib/waypoints/waypoints.min.js" type="59e992efeb54918d74bd7804-text/javascript"></script>
    <script src="lib/counterup/counterup.min.js" type="59e992efeb54918d74bd7804-text/javascript"></script>
    <script src="lib/owlcarousel/owl.carousel.min.js" type="59e992efeb54918d74bd7804-text/javascript"></script>
    <script src="lib/tempusdominus/js/moment.min.js" type="59e992efeb54918d74bd7804-text/javascript"></script>
    <script src="lib/tempusdominus/js/moment-timezone.min.js" type="59e992efeb54918d74bd7804-text/javascript"></script>
    <script src="lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js" type="59e992efeb54918d74bd7804-text/javascript"></script>
    <script src="lib/twentytwenty/jquery.event.move.js" type="59e992efeb54918d74bd7804-text/javascript"></script>
    <script src="lib/twentytwenty/jquery.twentytwenty.js" type="59e992efeb54918d74bd7804-text/javascript"></script>

    <!-- Template Javascript -->
    <script src="js/main.js" type="59e992efeb54918d74bd7804-text/javascript"></script>
<script src="cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="59e992efeb54918d74bd7804-|49" defer></script></body>


<!-- Mirrored from blog-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Sep 2025 10:14:46 GMT -->
</html>